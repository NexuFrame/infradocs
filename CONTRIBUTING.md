...
- Check if the bug has already been reported in [Issues](https://github.com/NexuFrame/build-the-infradocs-generator-python-cli/issues)
...
```bash
# Clone your fork
git clone https://github.com/your-username/build-the-infradocs-generator-python-cli.git
cd build-the-infradocs-generator-python-cli
