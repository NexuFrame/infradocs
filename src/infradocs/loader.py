...
class DataLoader:
    ...
    def load_all(self) -> Dict[str, Any]:
        ...
        file_mappings = {
            ...
            'printers': ['printers.csv', 'printers.yaml', 'printers.yml', 'printers.json'],
            'vendors': ['vendors.yaml', 'vendors.yml', 'vendors.json'],
            'circuits': ['circuits.yaml', 'circuits.yml', 'circuits.json'],
            'change_log': ['change-log.yaml', 'change-log.yml', 'changelog.yaml', 'changelog.yml'],
            'emergency_procedures': ['emergency-procedures.yaml', 'emergency-procedures.yml', 
                                    'emergency.yaml', 'emergency.yml'],
        }
