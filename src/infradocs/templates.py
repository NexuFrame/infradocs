...
class TemplateRenderer:
    ...
    def __init__(self, templates_dir: str, assets_dir: Optional[str] = None):
        ...
        self.assets_dir = Path(assets_dir) if assets_dir else self.templates_dir / 'assets'
...
def create_renderer(templates_dir: str, assets_dir: Optional[str] = None) -> TemplateRenderer:
